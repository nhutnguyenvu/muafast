 ...
 * @category    My
 * @package     My_Ieditor
 * @copyright   Copyright (c) 2012 Magento-Service. (http://www.magento-service.com)
...
class My_Ieditor_Block_Adminhtml_System_Email_Template_Edit extends Mage_Adminhtml_Block_Widget
{

    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('my_ieditor/system/email/template/edit.phtml');
    }
