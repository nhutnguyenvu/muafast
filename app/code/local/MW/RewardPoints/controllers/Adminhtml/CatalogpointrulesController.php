...
class MW_Rewardpoints_Adminhtml_CatalogpointrulesController extends Mage_Adminhtml_Controller_action {
    ...
    public function saveAction()
    {
        if ($this->getRequest()->getPost()) {
            ...
            try {
				...
				$readresult = $write -> query("UPDATE ".Mage::getSingleton('core/resource')->getTableName('mw_rewardpoints_catalogrules')." 
