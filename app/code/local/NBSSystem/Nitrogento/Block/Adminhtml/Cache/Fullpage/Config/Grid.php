...
class NBSSystem_Nitrogento_Block_Adminhtml_Cache_Fullpage_Config_Grid extends NBSSystem_Nitrogento_Block_Adminhtml_Cache_Common_Grid
{
    ...
    {
        $collection = Mage::getModel('nitrogento/cache_fullpage_config')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('full_action_name', array(
            'header'    => Mage::helper('nitrogento')->__('Full Action Name'),
            'align'     => 'left',
