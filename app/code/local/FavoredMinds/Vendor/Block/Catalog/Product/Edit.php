 ...
 */
class FavoredMinds_Vendor_Block_Catalog_Product_Edit extends Mage_Adminhtml_Block_Catalog_Product_Edit
{
    ...
    protected function _prepareLayout()
    {
        ...
        if($is_login){
            ...
            if(!empty($id)){
                ...
                $option_id = intval($product->getManufacturer());

                $vendorInfo = $_helper->getVendorUserInfo($_helper->getVendorUserId());

                if($option_id!= intval($vendorInfo['vendor_code'])){
                    echo "Id didn't existed";
                    die;
                }
            }
